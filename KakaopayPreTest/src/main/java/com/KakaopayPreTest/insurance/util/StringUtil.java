...
public class StringUtil {
	...
	/**
	 * 주어진 길이(iLength)만큼 주어진 문자(cPadder)를 strSource의 왼쪽에 붙혀서 보내준다. ex) lpad("abc",
	 * 5, '^') ==> "^^abc" lpad("abcdefghi", 5, '^') ==> "abcde" lpad(null, 5, '^')
	 * ==> "^^^^^"
	 *
	 * @param strSource
	 * @param iLength
	...
	/**
	 * 주어진 길이(iLength)만큼 주어진 문자(cPadder)를 strSource의 오른쪽에 붙혀서 보내준다. ex) lpad("abc",
	 * 5, '^') ==> "abc^^" lpad("abcdefghi", 5, '^') ==> "abcde" lpad(null, 5, '^')
	 * ==> "^^^^^"
	 *
	 * @param strSource
